/*
 * Created by JFormDesigner on Thu Dec 01 15:55:24 CST 2022
 */
...
public class CreateUser extends JFrame {
    ...
    private void handleSubmit() {
        ...
        if (DataProcessing.addUser(username, password, role))
            Message.setText("创建成功");
        else
            Message.setText("创建失败");
    }
